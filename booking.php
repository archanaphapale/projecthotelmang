...
<body>
	<div id="full">
		<div  style="background-image: url('img/h7.jpg');background-size: 100% 750px; width: 100%; height: 750px">
		<div id="header">
			<div id="logo">
			...
			<div id="nav">
				<ul id="a1">
					...
					<li><a href="db.php">Remove cust.Data</a></li>
					<li><a href="contect.php">Help</a></li>
				</ul>
			</div>
		</div>
		<div id="banner"><br><br><br><br><br><br><br><br><br><br><br>
			<h1 style="color:white; text-align: center; ">ALL CUSTOMER DATA</h1>
