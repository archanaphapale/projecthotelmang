...
<body>
	<div id="full">
		<div  style="background-image: url('img/c7.jpg');background-size: cover; width: 100%; height: 710px">
		<div id="header">
			<div id="logo">
			...
			<div id="nav">
				<ul id="a1">
					...
					<li><a href="d.php">Room Delete</a></li>
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br><br><br>
			<h1 style="color:white;text-align: center; ">All Room Data</h1>
